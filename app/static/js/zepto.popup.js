        ...
        $.extend($popUp, {
            pop: function() {
                if (settings.animation) {
                    ...
                    $popUp.css({display: '-webkit-box', 'z-index': settings.zIndex || 2, opacity: 0.8});
                }
